...
import edu.zjsr.yygh.service.PwdService;
import edu.zjsr.yygh.service.TokenService;
...
public class UserController {
    ...
    public Message getUserList(@RequestParam Integer page,
        ...
        try {
            List<UserManageVO> userList = userService.findAllUser(UserRole.ROLE_SYS_ADMIN, page, size);
            Integer count = userService.getUserCountByRole(UserRole.ROLE_SYS_ADMIN);
